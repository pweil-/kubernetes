...
type mustRunAs struct {
	opts *experimental.RunAsUserStrategyOptions
}

var _ RunAsUserStrategy = &mustRunAs{}

// NewMustRunAs provides a strategy that requires the container to run as a specific UID.
func NewMustRunAs(options *experimental.RunAsUserStrategyOptions) (RunAsUserStrategy, error) {
	if options == nil {
