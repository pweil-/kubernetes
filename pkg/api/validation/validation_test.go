...
func TestValidateSecurityContext(t *testing.T) {
	...
	seLinuxDisabled := fullValidSC()
	seLinuxDisabled.SELinuxOptions = &api.SELinuxOptions{Disabled: true}
	...
	successCases := map[string]struct {
		...
		"selinux disabled": {seLinuxDisabled},
	...
	mixingSELinuxDisabledWithLabels := fullValidSC()
	mixingSELinuxDisabledWithLabels.SELinuxOptions.Disabled = true
	...
	errorCases := map[string]struct {
		...
		"mixing SELinux disable with labels": {
			sc:          mixingSELinuxDisabledWithLabels,
			errorType:   "FieldValueInvalid",
