...
func TestModifyHostConfig(t *testing.T) {
	...
	seLinuxDisabledSC := fullValidSecurityContext()
	seLinuxDisabledSC.SELinuxOptions.Disabled = true
	seLinuxDisabledHC := fullValidHostConfig()
	seLinuxDisabledHC.SecurityOpt = []string{dockerLabelDisable}
